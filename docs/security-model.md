...
| №  | Загроза / Ризик                                                                                        | Як може проявитися / на який флоу впливає                                                                                                                                                                   |
| -- | ------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2.1  | **Неправильна авторизація / недостатня перевірка прав (Broken access control)**                        | Користувач може отримати доступ до чужих рахунків, чужих транзакцій, або виконати операції, на які не має прав — через баги або відсутність перевірки.                                             |
| 2.2  | **Injection-атаки (SQL injection, NoSQL injection)**                 | Якщо дані від користувача неправильно перевіряються, то можливі маніпуляції з базою, крадіжка або псування даних.                                                             |
| 2.3  | **Передача/зберігання чутливих даних без шифрування / слабке шифрування**                              | Баланси, історія транзакцій, персональні дані можуть бути витягнуті або зчитані, якщо дані "на диску" або "в мережі" не захищені належним чином.                                                    |
| 2.4  | **Недостатня валідація або перевірка введених даних**             | Це може призвести до XSS або інших логічних/функціональних багів: наприклад, запис небезпечних даних, зміна поведінки системи.                                               |
| 2.5  | **CSRF**                  | Зловмисник може змусити авторизованого користувача виконати небажані дії. (флоу 2)                                                                                               |
| 2.6  | **Недостатня логіка аудиту / запису логів / моніторингу — відсутність або слабкі логи**              | При компрометації облікового запису або атаці може бути важко відстежити, що сталося, хто і коли.                                                                                                 |
...
Найбільша небезпека для фінансового застосунку з точки зору критичності: 1.1, 1.2, 2.1, 2.2, 2.3, 2.4, 1.4, 2.5, 2.6.
